<template>
  <div class="my">
      ...
      <cell-box>
        <div class="order-type-box">
          <div class="type-item" @click="toWaitPay">
            <img src="../../assets/img/icon/icon-type-wait.png"/>
            <span>待付款</span>
          </div>
          <div class="type-item" @click="toWaitGet">
            <img src="../../assets/img/icon/icon-type-get.png"/>
            <span>待收货</span>
          </div>
    ...
    <group>
      ...
      <cell title="客服MM" is-link :link="{path:'/page/customer'}"></cell>
